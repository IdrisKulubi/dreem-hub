      ...
      <div className="relative container py-16 md:py-20 lg:py-24">
        ...
        <div className="grid gap-8 md:gap-12 lg:gap-16 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-200 uppercase tracking-wider">Quick Links</h3>
            <nav className="flex flex-col space-y-3" aria-label="Footer navigation">
              <Link href="/#impact" className="text-sm text-slate-600 dark:text-slate-400 hover:text-dreem-orange transition-colors duration-200 inline-flex items-center group">
                <span className="w-0 group-hover:w-2 h-px bg-dreem-orange transition-all duration-200 mr-0 group-hover:mr-2"></span>
                Our Impact
              </Link>
              <Link href="/#model" className="text-sm text-slate-600 dark:text-slate-400 hover:text-dreem-orange transition-colors duration-200 inline-flex items-center group">
                <span className="w-0 group-hover:w-2 h-px bg-dreem-orange transition-all duration-200 mr-0 group-hover:mr-2"></span>
                The Model
              </Link>
              <Link href="/#regional-focus" className="text-sm text-slate-600 dark:text-slate-400 hover:text-dreem-orange transition-colors duration-200 inline-flex items-center group">
                <span className="w-0 group-hover:w-2 h-px bg-dreem-orange transition-all duration-200 mr-0 group-hover:mr-2"></span>
                Regional Focus
              </Link>
              <Link href="/#value-chains" className="text-sm text-slate-600 dark:text-slate-400 hover:text-dreem-orange transition-colors duration-200 inline-flex items-center group">
                <span className="w-0 group-hover:w-2 h-px bg-dreem-orange transition-all duration-200 mr-0 group-hover:mr-2"></span>
                Value Chains
              </Link>
              <Link href="/#partners" className="text-sm text-slate-600 dark:text-slate-400 hover:text-dreem-orange transition-colors duration-200 inline-flex items-center group">
                <span className="w-0 group-hover:w-2 h-px bg-dreem-orange transition-all duration-200 mr-0 group-hover:mr-2"></span>
                Partners
              </Link>
            </nav>
          ...
          {/* Contact Information */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-200 uppercase tracking-wider">Contact</h3>
            <div className="flex flex-col space-y-3">
              <a
                href="mailto:info@dreemhub.org"
                className="group flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400 hover:text-dreem-orange transition-colors duration-200"
                aria-label="Send email to info@dreemhub.org"
              >
                <Mail className="h-5 w-5 mt-0.5 text-slate-500 dark:text-slate-400 group-hover:text-dreem-orange transition-colors duration-200 shrink-0" aria-hidden="true" />
                <span>info@dreemhub.org</span>
              </a>
              <div className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400">
                <MapPin className="h-5 w-5 mt-0.5 text-slate-500 dark:text-slate-400 shrink-0" aria-hidden="true" />
