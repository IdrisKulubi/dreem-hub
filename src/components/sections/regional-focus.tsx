                        ...
                        <TabsList className="h-auto p-1.5 bg-white dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-full shadow-sm">
                            {homeContent.regions.map((region) => (
                                <TabsTrigger
                                    key={region.id}
                                    value={region.id}
                                    className="rounded-full px-6 py-3 text-base font-medium data-[state=active]:bg-dreem-orange data-[state=active]:text-white transition-all duration-300"
                                >
                                    ...
                                    <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 border border-slate-100 dark:border-slate-700 shadow-xl shadow-slate-200/50 dark:shadow-none h-full">
                                        ...
                                        <div className="space-y-6">
                                            <div>
                                                ...
                                                <div className="inline-flex items-center px-3 py-1 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-medium text-sm">
                                                    {region.focus}
                                                </div>
                                            </div>
                                ...
                                <div className="lg:col-span-7 space-y-6">
                                    <div className="grid sm:grid-cols-2 gap-4">
                                        {region.challenges.map((item, idx) => (
                                            <Card key={idx} className="border-none shadow-md hover:shadow-lg transition-shadow duration-300 bg-white dark:bg-slate-800 overflow-hidden group">
                                                ...
                                                <CardContent className="p-6">
                                                    ...
                                                    <h4 className="font-semibold text-slate-900 dark:text-white mb-2 group-hover:text-dreem-orange transition-colors">
                                                        {item.title}
                                                    </h4>

                                                    <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-700">
                                                        <div className="flex items-center gap-2 text-sm font-medium text-dreem-orange mb-1">
                                        ...
                                        <Card className="border-none shadow-md bg-gradient-to-br from-slate-900 to-slate-800 text-white flex flex-col justify-center items-center text-center p-6">
                                            ...
                                            <button className="text-xs font-bold uppercase tracking-wider hover:text-dreem-orange transition-colors">
                                                Download PDF
                                            </button>
                                        </Card>
                                    </div>
